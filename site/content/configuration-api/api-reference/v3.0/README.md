...
* Logged in BOT Agent is connected to agent SSO access token that
  ...
  revoked or expires. `Basic` token (Personal token) has expiration time of 5 days.
...
* `action` possible values:
  ...
  * `agent_deleted` - triggers when some agent is deleted,
    available filters for the action: `chat_member_ids`
  * `events_marked_as_seen` - triggers on action [agent-api push](https://developers.livechatinc.com/docs/agent-chat-api/#events_marked_as_seen),
    available filters for the action: `chat_member_ids`, `only_my_chats`
  * `access_granted` - triggers on action [agent-api push](https://developers.livechatinc.com/docs/agent-chat-api/#access_granted),
    available filters for the action: `chat_member_ids`, `only_my_chats`
  * `access_revoked` - triggers on action [agent-api push](https://developers.livechatinc.com/docs/agent-chat-api/#access_revoked),
    available filters for the action: `chat_member_ids`, `only_my_chats`
  * `access_set` - triggers on action [agent-api push](https://developers.livechatinc.com/docs/agent-chat-api/#access_set),
    available filters for the action: `chat_member_ids`, `only_my_chats`
  * `customer_created` - triggers on action [agent-api push](https://developers.livechatinc.com/docs/agent-chat-api/#customer_created)
...
* [`events_marked_as_seen`](https://developers.livechatinc.com/docs/agent-chat-api/#events_marked_as_seen)
* [`access_granted`](https://developers.livechatinc.com/beta-docs/agent-chat-api/#access_granted)
* [`access_revoked`](https://developers.livechatinc.com/beta-docs/agent-chat-api/#access_revoked)
* [`access_set`](https://developers.livechatinc.com/beta-docs/agent-chat-api/#access_set)
* [`customer_created`](https://developers.livechatinc.com/beta-docs/agent-chat-api/#customer_created)
