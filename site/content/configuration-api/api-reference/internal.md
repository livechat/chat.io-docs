...
|                 | `greeting_id`               | `int`    | rw for customer in thread and chat, r for agent and customer in event |                       |
|                 | `greeting_unique_id`        | `string` | rw for customer in thread and chat, r for agent and customer in event |                       |
...
|                 | `require_online_group`      | `bool`   | r for agent and customer in chat                                      |                       |
| `source`        | `type`                      | `string` | r for customer and agent in thread, rw for customer and agent in chat |                       |
|                 | `client_id`                 | `string` | r for agent and customer in event                                     |                       |
