...
|                 | `ignore_bots`               | `bool`   | w for customer in thread                                               |                       |
...
| `translation`   | `source_lang_code`          | `string` | rw for agents, r for customer in event                                 |                       |
|                 | `target_lang_code`          | `string` | rw for agents, r for customer in event                                 |                       |
|                 | `target_message`            | `string` | rw for agents, r for customer in event                                 |                       |
