...
|--------|------------------|
| `chat_id` | |
| `properties` | this is not full properties object, this push shows only properties wchich was recently updated by method update_chat_properties (in both APIs) |
