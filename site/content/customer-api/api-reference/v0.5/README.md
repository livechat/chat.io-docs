...
```
* `text`, `custom_id` and `properties` are optional
...
* `template_id` describes how the event should be presented in app
* `elements.buttons.postback_id` describes action sent via method `send_rich_message_postback`
