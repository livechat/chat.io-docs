...
This documentation describes version **v0.6** of customer-api.
...
|--------|----------------|
| `POST` | `https://api.chat.io/customer/v0.6/action/<action>` |
...
| Transport | Endpoint |
|--------|----------------|
| `socket.io` | `https://api.chat.io/customer/v0.6/rtm/sio` |
| `websocket` | `wss://api.chat.io/customer/v0.6/rtm/ws` |
...
```
https://api.chat.io/customer/v0.6/rtm/ws?license_id=123456789
```
