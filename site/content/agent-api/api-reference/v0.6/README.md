...
This documentation describes version **v0.6** of agent-api.
...
|--------|----------------|
| `POST` | `https://api.chat.io/agent/v0.6/action/<action>` |
...
| Transport | Endpoint |
|--------|----------------|
| `socket.io` | `https://api.chat.io/agent/v0.6/rtm/sio` |
| `websocket` | `wss://api.chat.io/agent/v0.6/rtm/ws` |

##### Example

```
https://api.chat.io/agent/v0.6/rtm/ws
```
